  ...
  public void _whenIInvokeTheCodeCompletionAfterEPackageStatemachineMMN() {
    ...
    final Connected _function = new Connected() {
      public Connector getConnector() {
        return CodeCompletionFeatureProposalSignalsBackendCurrentlyLoading.this.b.connector;
      }
    };
    ...
    final Runnable _function_1 = new Runnable() {
      public void run() {
        ...
        ICompletionProposal[] _computeCompletionProposals = CodeCompletionFeatureProposalSignalsBackendCurrentlyLoading.this.proposalProvider.computeCompletionProposals(CodeCompletionFeatureProposalSignalsBackendCurrentlyLoading.this.b.document, _offsetAfter, 0);
