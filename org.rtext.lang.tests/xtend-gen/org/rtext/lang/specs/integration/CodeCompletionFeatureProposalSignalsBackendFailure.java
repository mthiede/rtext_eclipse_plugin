...
public class CodeCompletionFeatureProposalSignalsBackendFailure extends CodeCompletionFeature {
  ...
  public void _givenABackendForRtextTestIntegrationModelTestCrashingBackend() {
    final StepArguments args = new StepArguments("rtext/test/integration/model/test.crashing_backend");
  ...
  public void _whenIInvokeTheCodeCompletionAfterEPackageStatemachineMMN() {
    ...
    final Connected _function = new Connected() {
      public Connector getConnector() {
        return CodeCompletionFeatureProposalSignalsBackendFailure.this.b.connector;
      }
    };
    ...
    final Runnable _function_1 = new Runnable() {
      public void run() {
        ...
        ICompletionProposal[] _computeCompletionProposals = CodeCompletionFeatureProposalSignalsBackendFailure.this.proposalProvider.computeCompletionProposals(CodeCompletionFeatureProposalSignalsBackendFailure.this.b.document, _offsetAfter, 0);
