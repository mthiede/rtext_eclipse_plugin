...
public class CodeCompletionFeatureCodeCompletionForNestedElements extends CodeCompletionFeature {
  ...
  public void _whenIInvokeTheCodeCompletionAfterEClass() {
    final StepArguments args = new StepArguments("EClass ");
    final Connected _function = new Connected() {
      public Connector getConnector() {
        return CodeCompletionFeatureCodeCompletionForNestedElements.this.b.connector;
      }
    };
    ...
    final Runnable _function_1 = new Runnable() {
      public void run() {
        ...
        ICompletionProposal[] _computeCompletionProposals = CodeCompletionFeatureCodeCompletionForNestedElements.this.proposalProvider.computeCompletionProposals(CodeCompletionFeatureCodeCompletionForNestedElements.this.b.document, _offsetAfter, 0);
  ...
  public void _thenTheProposalsShouldBe() {
    final StepArguments args = new StepArguments("name [name] <EString>\nabstract: <EBoolean>\ninterface: <EBoolean>\neSuperTypes: <EClass>\ninstanceClassName: <EString>\n");
    String _first = JnarioIterableExtensions.<String>first(args);
