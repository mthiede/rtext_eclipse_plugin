...
import org.rtext.lang.specs.unit.util.StringsSpecExamples;
...
public class StringsSpec {
  public ExampleTable<StringsSpecExamples> _initStringsSpecExamples() {
    ...
    List<String> _list_3 = JnarioCollectionLiterals.<String>list("ruby", "-l", "arg");return ExampleTable.create("examples", 
      ...
      new StringsSpecExamples(  java.util.Arrays.asList("\"ruby\"", "list(\"ruby\")"), "ruby", _list),
      new StringsSpecExamples(  java.util.Arrays.asList("\"ruby -l\"", "list(\"ruby\", \"-l\")"), "ruby -l", _list_1),
      new StringsSpecExamples(  java.util.Arrays.asList("\"ruby  -l\"", "list(\"ruby\", \"-l\")"), "ruby  -l", _list_2),
      new StringsSpecExamples(  java.util.Arrays.asList("\'ruby -l \"arg\"\'", "list(\"ruby\", \"-l\", \"arg\")"), "ruby -l \"arg\"", _list_3)
    );
  }
  
  protected ExampleTable<StringsSpecExamples> examples = _initStringsSpecExamples();
  ...
  public void _examplesForEachStringsSplitCommandInputToListResult() throws Exception {
    final Procedure1<StringsSpecExamples> _function = new Procedure1<StringsSpecExamples>() {
        public void apply(final StringsSpecExamples it) {
    ...
    ExampleTableIterators.<StringsSpecExamples>forEach(this.examples, _function);
  }
}
