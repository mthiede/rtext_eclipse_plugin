...
import org.rtext.lang.specs.unit.backend.ContextParserSpec;
...
@Named("Regression")
@Contains({ CommandExecutorSpec.class, CommandQueueSpec.class, ConnectorSpec.class, ConnectorConfigSpec.class, ConnectorProviderSpec.class, ConnectorScopeSpec.class, ContextParserSpec.class, DefaultConnectorProviderSpec.class, FilesSpec.class, LoadModelCallbackSpec.class, ResponseParserSpec.class, RTextFileChangeListenerSpec.class, RTextFileParserSpec.class, RTextFilesSpec.class, RTextModelParserSpec.class, StringsSpec.class, SyntaxScannerSpec.class, TcpClientSpec.class })
