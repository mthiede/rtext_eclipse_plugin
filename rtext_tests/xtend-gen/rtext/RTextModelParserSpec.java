...
import rtext.RTextModelParserErrorHandlingSpec;
import rtext.RTextModelParserFullTextRegionSpec;
import rtext.RTextModelParserStructureSpec;
...
public class RTextModelParserSpec {
  ...
  public boolean operator_doubleArrow(final Object actual, final Object expected) {
    boolean _and = ((actual instanceof String) && (expected instanceof String));
    if (_and) {
